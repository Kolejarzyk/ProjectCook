...
class HomePage : AppCompatActivity() {
    ...
    private fun populateDatabase()
    {
        ...
        val recipe1 = Recipe(2, "Kucharzenie ","toś", mutableListOf(product), Date(2018,9,23),14)
        val recipe2 = Recipe(3, "Kucharzenie","poś", mutableListOf(product), Date(2018,9,23),7)
        val recipe3 = Recipe(4, "Kucharzenie ","łoś", mutableListOf(product), Date(2018,9,23),78)
        val recipe4 = Recipe(5, "Kucharzenie","coś", mutableListOf(product), Date(2018,9,23),45)
